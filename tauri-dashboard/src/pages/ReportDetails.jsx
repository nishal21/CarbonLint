...
import { ArrowLeft, FileText, Folder, Terminal, GitBranch, Clock, Cpu, HardDrive, Wifi, Globe, Zap, Leaf, Smartphone, Search, Car, Tv, GitCompare, Lightbulb, Copy, FileDown } from 'lucide-react';
        ...
        <div className="animate-fade-in">
            ...
            <div className="card">
                ...
                <div className="flex gap-md flex-wrap">
                    ...
                    {window.electronAPI && (
                        <button className="btn btn-secondary flex items-center gap-xs" onClick={async () => {
                            const result = await window.electronAPI.exportPDF();
                            if (!result.success) alert('Failed to export: ' + result.error);
                        }}>
